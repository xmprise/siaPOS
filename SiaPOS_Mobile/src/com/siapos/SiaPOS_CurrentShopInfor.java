...
public class SiaPOS_CurrentShopInfor extends Activity{
	private static final String SOAP_ACTION = "http://tempuri.org/getTempShop";
	private static final String METHOD_NAME = "getTempShop";
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.currentsalesresut);        
        
        Intent intent = getIntent();
        id = intent.getStringExtra("id");
      	
        tv1 = (TextView)findViewById(R.id.txtcurrentRuser);
        tv1.setText("ShopID("+id + "). SiaPOS Mobile Service.");
        
        mylist = (ListView)findViewById(R.id.currentresutlist);
