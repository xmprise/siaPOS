<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMaster.master" StylesheetTheme="SiaPOSTheme" 
AutoEventWireup="false" CodeFile="AddCommand.aspx.vb" Inherits="AddCommand" %>
...
<h2>지시사항 전달</h2>
<p>매장 내 지시사항을 잔달하시려면 아래 폼을 작성하셔서 등록해 주세요.</p>
<p>&nbsp;</p>
    <!--Ajax UpdatePanel-->
